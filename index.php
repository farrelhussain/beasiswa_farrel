...
<body class="bg-secondary">
    <div class="container">
        ...
        <!-- ini merupakan bagian form daftar beasiswa -->
...
if(isset($_POST['submit'])) {
    ...
    if($nama == '' || $email == '' || $nomorHp == '' || $semester == '' || $ipk == '' || $berkas == '') {
        ...
        $sql = "INSERT INTO daftar_beasiswa (nama, email, no_hp, semester, last_ipk, beasiswa, syarat_berkas, status_ajuan) VALUES ('$nama', '$email', '$nomorhp', '$semester', '$ipk', '$beasiswa', '$berkas', '$status')";
        // Cek koneksi

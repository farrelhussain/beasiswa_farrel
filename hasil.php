            ...
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                    <?php 
                        ...
                        $sql = "SELECT * FROM daftar_beasiswa";
                    ...
                    ?>
                    <tr>
                        <!-- Menampilkan data pada tabel dari database -->
                        ...
                        <td>
                            ...
                            <a class="btn btn-primary" href="function/download.php?filename=<?php echo $row["syarat_berkas"]; ?>">
                        ...
                        <td>
                            <!-- Tombol delete -->
                            <a class="btn btn-danger" href="function/delete.php?id=<?php echo $row["id"]; ?>">
